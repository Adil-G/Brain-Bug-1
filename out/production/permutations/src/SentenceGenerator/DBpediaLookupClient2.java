...
public class DBpediaLookupClient2 extends DefaultHandler {
    public DBpediaLookupClient2(String query) throws Exception {
        this.query = query;
        //System.out.println("\n query: " + query);
    ...
    public static void main(String[] args) throws Exception {
        DBpediaLookupClient2 lookup = new DBpediaLookupClient2("berlin");
