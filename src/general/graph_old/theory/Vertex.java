...
public class Vertex {
    ...
    private ArrayList<general.graph_old.theory.Edge> neighborhood;
    ...
    public Vertex(String label){
        ...
        this.neighborhood = new ArrayList<general.graph_old.theory.Edge>();
    ...
    public void addNeighbor(general.graph_old.theory.Edge edge){
    ...
    public boolean containsNeighbor(general.graph_old.theory.Edge other){
    ...
    public general.graph_old.theory.Edge getNeighbor(int index){
    ...
    general.graph_old.theory.Edge removeNeighbor(int index){
    ...
    public void removeNeighbor(general.graph_old.theory.Edge e){
    ...
    public ArrayList<general.graph_old.theory.Edge> getNeighbors(){

        return new ArrayList<general.graph_old.theory.Edge>(this.neighborhood);
